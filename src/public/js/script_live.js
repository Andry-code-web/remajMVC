...
document
  .getElementById("seguimiento-<%= auction.id %>")
  .addEventListener("click", function () {
    // Lógica para manejar el seguimiento de la subasta
  });

document
  .getElementById("detalles-<%= auction.id %>")
  .addEventListener("click", function () {
    // Lógica para mostrar detalles en un modal
  });

document
  .getElementById("aviso-<%= auction.id %>")
  .addEventListener("click", function () {
    // Lógica para mostrar un aviso de la subasta
  });
